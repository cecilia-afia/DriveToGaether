...
class Window(Frame):
    def __init__(self, master=None):
        ...
        self.players_label = Label(top, text="Nb players", fg="black")
        self.players_label.place(x=10,y=10)
        self.text_players = Text(top, height=1, width=10)
        self.text_players.place(x=100,y=10)

        # TO MODIFY THE NUMBER OF ROBOTS
        self.robots_label = Label(top, text="Nb robots", fg="black")
        self.robots_label.place(x=10,y=40)
        self.text_robots = Text(top, height=1, width=10)
        self.text_robots.place(x=100,y=40)

        # TO MODIFY THE DIMENSION OF THE GRID
        self.dimension_label = Label(top, text="Dimension :", fg="black")
        self.dimension_label.place(x=10,y=70)
        self.rows_label = Label(top, text="Rows", fg="black")
        self.rows_label.place(x=100,y=70)
        self.text_rows = Text(top, height=1, width=5)
        self.text_rows.place(x=150,y=70)
        self.col_label = Label(top, text="Columns", fg="black")
        self.col_label.place(x=220,y=70)
        self.text_col = Text(top, height=1, width=5)
        self.text_col.place(x=290,y=70)

        """
        # TO AFFECT ROBOTS TO PLAYERS
        self.affect_label = Label(top, text="Affectation", fg="black")
        self.affect_label.place(x=10,y=100)
        self.text_affect = Text(top, height=1, width=30)
        self.text_affect.place(x=100,y=100)
        """

        # TO ENTER THE TERRAIN REPRESENTATION
        self.ground_label = Label(top, text="Ground", fg="black")
        self.ground_label.place(x=10,y=130)
        self.text_ground = Text(top, height=8, width=30)
        ...
        # CREATE A DUMMY BUTTON WITH ONE OF THE IMAGE WE LOADED ON TOP OF IT #
        ...
        self.buttonDH = Button(top, image=self.droiteH_btn, command=self.write_droiteH, borderwidth=0)
        self.buttonDH.place(x=100,y=280)

        self.buttonDV = Button(top, image=self.droiteV_btn, command=self.write_droiteV, borderwidth=0)
        self.buttonDV.place(x=150,y=280)

        self.buttonVNE = Button(top, image=self.virageNE_btn,command=self.write_virageNE, borderwidth=0)
        self.buttonVNE.place(x=200, y=280)

        self.buttonVNO = Button(top, image=self.virageNO_btn,command=self.write_virageNO, borderwidth=0)
        self.buttonVNO.place(x=250, y=280)

        self.buttonVSE = Button(top, image=self.virageSE_btn,command=self.write_virageSE, borderwidth=0)
        self.buttonVSE.place(x=300, y=280)

        self.buttonVSO = Button(top, image=self.virageSO_btn,command=self.write_virageSO, borderwidth=0)
        self.buttonVSO.place(x=100, y=320)

        self.buttonIN = Button(top, image=self.intersectionN_btn, command=self.write_intersectionN, borderwidth=0)
        self.buttonIN.place(x=150, y=320)

        self.buttonIE = Button(top, image=self.intersectionE_btn, command=self.write_intersectionE, borderwidth=0)
        self.buttonIE.place(x=200, y=320)

        self.buttonIS = Button(top, image=self.intersectionS_btn, command=self.write_intersectionS, borderwidth=0)
        self.buttonIS.place(x=250, y=320)

        self.buttonIO = Button(top, image=self.intersectionO_btn, command=self.write_intersectionO, borderwidth=0)
        self.buttonIO.place(x=300, y=320)

        self.buttonVoid = Button(top, image=self.void_btn, command=self.write_void, borderwidth=0)
        self.buttonVoid.place(x=200, y=370)

        ## WRITE THE AFFECTATION OF EACH ROBOT
        self.format_infos_robot_label = Label(top,text="Affectation of each robot")
        self.format_infos_robot_label.place(x=10,y=420)

        # ROBOT 1
        self.robot1_label = Label(top, text="Robot 1", fg="black")
        self.robot1_label.place(x=10,y=460)
        self.robot1_text = Text(top, height=1, width=10)
        self.robot1_text.place(x=90,y=460)

        # ROBOT 2
        self.robot2_label = Label(top, text="Robot 2", fg="black")
        self.robot2_label.place(x=10,y=500)
        self.robot2_text = Text(top, height=1, width=10)
        self.robot2_text.place(x=90,y=500)

        # ROBOT 3
        self.robot3_label = Label(top, text="Robot 3", fg="black")
        self.robot3_label.place(x=10,y=540)
        self.robot3_text = Text(top, height=1, width=10)
        self.robot3_text.place(x=90,y=540)

        # ROBOT 4
        self.robot4_label = Label(top, text="Robot 4", fg="black")
        self.robot4_label.place(x=10,y=580)
        self.robot4_text = Text(top, height=1, width=10)
        self.robot4_text.place(x=90,y=580)

        # ROBOT 5
        self.robot5_label = Label(top, text="Robot 5", fg="black")
        self.robot5_label.place(x=10,y=620)
        self.robot5_text = Text(top, height=1, width=10)
        self.robot5_text.place(x=90,y=620)

        # ROBOT 6
        self.robot6_label = Label(top, text="Robot 6", fg="black")
        self.robot6_label.place(x=220,y=460)
        self.robot6_text = Text(top, height=1, width=10)
        self.robot6_text.place(x=300,y=460)

        # ROBOT 7
        self.robot7_label = Label(top, text="Robot 7", fg="black")
        self.robot7_label.place(x=220,y=500)
        self.robot7_text = Text(top, height=1, width=10)
        self.robot7_text.place(x=300,y=500)

        # ROBOT 8
        self.robot8_label = Label(top, text="Robot 8", fg="black")
        self.robot8_label.place(x=220,y=540)
        self.robot8_text = Text(top, height=1, width=10)
        self.robot8_text.place(x=300,y=540)

        # ROBOT 9
        self.robot9_label = Label(top, text="Robot 9", fg="black")
        self.robot9_label.place(x=220,y=580)
        self.robot9_text = Text(top, height=1, width=10)
        self.robot9_text.place(x=300,y=580)

        # ROBOT 10
        self.robot10_label = Label(top, text="Robot 10", fg="black")
        self.robot10_label.place(x=220,y=620)
        self.robot10_text = Text(top, height=1, width=10)
        self.robot10_text.place(x=300,y=620)

        ## WRITE THE POSITION OF SPECIAL POINTS (e.g HOSPITALS, VICTIMS)
        self.SP_label = Label(top, text="OPTIONAL EMPLACEMENTS")
        self.SP_label.place(x=10, y=660)

        # HOSPITALS
        self.hospitals_label = Label(top, text="Hospitals", fg="black")
        self.hospitals_label.place(x=10,y=700)
        self.hospitals_text = Text(top, height=1, width=10)
        self.hospitals_text.place(x=90, y=700)

        # VICTIMS
        self.victims_label = Label(top, text="Victims", fg="black")
        self.victims_label.place(x=220,y=700)
        self.victims_text = Text(top, height=1, width=10)
